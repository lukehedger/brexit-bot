...
export const FETCH_CHECKIN_REQUEST = `${name}/FETCH_CHECKIN_REQUEST`
export const FETCH_CHECKIN_SUCCESS = `${name}/FETCH_CHECKIN_SUCCESS`
export const FETCH_CHECKIN_FAILURE = `${name}/FETCH_CHECKIN_FAILURE`
